    ...
    )
{
    ...
    if (iter_num == 0)
    {
        /* calc_update_best_vals_sizes_common( */
        /*     conf, */
        /*     &local_work_size, */
        /*     &global_work_size, */
        /*     &swarms_per_group, */
    ...
    #if LAUNCH_WARNINGS
    printf("Launching update_best_vals_vec_common kernel.\n");
    ...
    set_update_best_vals_vec_kernel_args_common(
        conf,
        &(kernels[ALG_NAME_CAPS(UPDATE_BEST_VALS_VEC_KERNEL)]),
        bufs,
        swarms_per_group
        );
