    ...
    )
{
    ...
    //vstore4(r2 * max_vel * 2 - max_vel, 0, velocities + global_id * 4);
    ...
    {
        vstore4((float4) (0), 0, mut_counts + i * 4);
    }

    //not necessary since num_swarms is always divisible by 4
    /* for (i = global_id; !rep && i < (num_reps * num_swarms) % 4; i += get_global_size(0)) */
    /* { */
    /*     mut_counts[global_id] = 0; */
    /* } */
}
