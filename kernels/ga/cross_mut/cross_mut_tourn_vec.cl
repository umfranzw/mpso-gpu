...
void __kernel cross_mut_tourn_vec(
    ...
    /* __global float *test_tourn_indices, */
    /* __global float *test_tourn_vals, */
    /* __global float *test_tourn_sel, */
    /* __global float *test_tourn_mins, */
    /* __global float *test_local_mem */
    )
{
    ...
    uint tourn_mask = dim_id < (tourn_size / 4);
    uint dim_mask = dim_id < (num_dims / 4);
